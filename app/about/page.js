    ...
    <div className={styles.container}>
      ...
      <div className={styles.content_container}>
        <div className={styles.content_heading_container}>
          <h1 className={styles.content_heading_item}>Our Odyssey</h1>

          <h3 className={styles.content_heading_sub_item}>
            Our story unfolds through technology, precision engineering, and an
            unwavering commitment to innovation. Join us.
          </h3>
        </div>
        <div className={styles.about_content_section}>
          <div className={styles.main_content}>
            <span className={styles.main_heading}>Company</span>
            ...
            <div className={styles.body_content}>
              ...
              <div className={styles.body_content_info}>
                ...
                <p className={styles.body_sub_heading}>
                  Our range of products encompasses state-of-the-art hydraulic
                ...
                <p className={styles.body_sub_heading}>
                  Committed to upholding the highest industry standards, Tridev
                  Hydraulics proudly adheres to ISO 9001:2015 for quality
                  management systems and ISO 14001:2015 for environmental
                  management. These ISO certifications underscore our unwavering
                  dedication to delivering hydraulic solutions that not only
                  meet but exceed international benchmarks.
                </p>
                <p className={styles.body_sub_heading}>
                  Experience the difference with Tridev Hydraulics, where
